...
class DarkThemeData extends AppTheme {
  ...
  SvgPictureColors buildSvgPictureColor() {
    return const SvgPictureColors(
      textBtnActiveColor: AppColors.dmSecondaryColorKit,
      textBtnInactiveColor: AppColors.inactiveColorKit,
      elevatedBtnActiveColor: AppColors.dmPrimaryColor,
      elevatedBtnInactiveColor: AppColors.inactiveColorKit,
      greenColor: AppColors.dmGreenColorKit,
    );
  }
}
